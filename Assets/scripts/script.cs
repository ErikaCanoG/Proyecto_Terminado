...
public class NewBehaviourScript : MonoBehaviour
{
   private int vidas = 3;
    ...
    float fuerzaSalto = 150;  // x veces la masa del personaje 
    float fuerzaDesplazamiento = 800;  // Fuerza en Newtons
    ...
    void Start()
    {
        // personaje siempre inicia en la posicion (-22.32, -3.12)
        gameObject.transform.position = new Vector3(-22.32f,nivelTecho,0);
        Debug.Log("INIT");
